...
- 实现
  ...
  public class TestCreateClassLoader extends ClassLoader {
      ...
      public static void test(ClassLoader classLoader) throws Exception {
          Class<?> clazz = classLoader.loadClass("ClassLoader.TestClass1");
      ...
      public static void main(String[] args) throws Exception {
          TestCreateClassLoader testCreateClassLoader = new TestCreateClassLoader("ClassLoader.TestCreateClassLoader");
          test(testCreateClassLoader);
      }
  ...
  1.自定义加载器即使在main方法中初始化并使用，实际调用的依旧是系统加载器，因为双亲委托机制
